...
public class ValidarVersionMiniprogramaConsultarPQR implements Task {
    ...
    private static final String paso3 = "Validar versión de mini programa Consultar PQR";
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                ValidarTextoQueContengaX.elTextoContiene(CONSULTAR_PQR),
    ...
    public static Performable validar() {
        return instrumented(ValidarVersionMiniprogramaConsultarPQR.class);
    }
}
