...
public class ValidarVersionMiniprogramaNecesitasAyuda implements Task {
    ...
    private static final String paso3 = "Validar versión de mini programa Necesitas Ayuda?";
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                ValidarTextoQueContengaX.elTextoContiene(MINI_VERSION_NECESITAS_AYUDA_CONSTANT)
        );
    ...
    public static Performable validar() {
        return instrumented(ValidarVersionMiniprogramaNecesitasAyuda.class);
    }
}
