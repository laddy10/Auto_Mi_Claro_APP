...
public class TarjetaCreditoDebito implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    actor.attemptsTo(
        ValidarTexto.validarTexto(GUARDAR_DATOS_TARJETA), ValidarTexto.validarTexto(PAGAR));
  ...
  private <T extends Actor> void validarTiposDocumento(T actor) {
    String[] tiposDocumento = {
      CEDULA_CIUDADANIA, CEDULA_EXTRANJERIA, PASAPORTE, NUMERO_IDENTIFICACION_TRIBUTARIA
    };
