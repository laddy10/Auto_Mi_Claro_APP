...
public class ValidarTerminosCondicionesNetflix implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    actor.attemptsTo(ValidarTexto.validarTexto(CONTINUAR), Click.on(BTN_CONTINUAR));
    EvidenciaUtils.registrarCaptura(paso3);
    actor.attemptsTo(ValidarTexto.validarTexto(CONTINUAR), Click.on(BTN_CONTINUAR_2));
    EvidenciaUtils.registrarCaptura(paso4);
    actor.attemptsTo(ValidarTexto.validarTexto(ACEPTAR_2), Click.on(BTN_ACEPTAR_ET));
  }
