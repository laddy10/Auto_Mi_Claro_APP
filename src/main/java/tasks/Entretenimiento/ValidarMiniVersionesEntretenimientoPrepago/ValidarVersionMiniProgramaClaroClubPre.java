...
import static utils.ConstantsMiniVersiones.Versiones.MINI_VERSION_CLARO_CLUB_CONSTANT;
...
import tasks.Entretenimiento.ValidarMiniVersionesEntretenimientoPospago.ValidarVersionMiniProgramaClaroClub;
import utils.AndroidObject;
import utils.EvidenciaUtils;
import utils.TestDataProvider;

public class ValidarVersionMiniProgramaClaroClubPre implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    actor.attemptsTo(
        ...
        VerificarVersionModulo.conLaEsperada(MINI_VERSION_CLARO_CLUB_CONSTANT));
    ...
    actor.attemptsTo(ClickTextoQueContengaX.elTextoContiene(LINEA_PREPAGO), WaitFor.aTime(4000));
  }

  public static Performable validar() {
    return instrumented(ValidarVersionMiniProgramaClaroClub.class);
  }
}
