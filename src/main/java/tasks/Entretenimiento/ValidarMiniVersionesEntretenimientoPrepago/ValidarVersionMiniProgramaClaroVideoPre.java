...
import tasks.Entretenimiento.ValidarMiniVersionesEntretenimientoPospago.ValidarVersionMiniProgramaClaroVideo;
...
public class ValidarVersionMiniProgramaClaroVideoPre implements Task {
    private static final User user = TestDataProvider.getRealUser();
    public static final String LINEA_PREPAGO = "310 222 3558";
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                ValidarTextoQueContengaX.elTextoContiene(MINI_VERSION_CLARO_VIDEO_CONSTANT)
        );
    ...
    public static Performable validar() {
        return instrumented(ValidarVersionMiniProgramaClaroVideoPre.class);
    }
}
