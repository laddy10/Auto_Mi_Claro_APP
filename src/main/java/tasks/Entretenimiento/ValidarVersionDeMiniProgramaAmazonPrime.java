...
public class ValidarVersionDeMiniProgramaAmazonPrime implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    // **********************************************************************************
    actor.attemptsTo(
        WaitForResponse.withText("Ver"), ValidarTextoQueContengaX.elTextoContiene("Ver"));
  ...
  public static Performable validar() {
    return instrumented(ValidarVersionDeMiniProgramaAmazonPrime.class);
  }
}
