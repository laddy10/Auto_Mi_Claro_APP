...
public class ValidarVersionMiniProgramaClaroVideo implements Task {
    ...
    private static final String paso3 = "Validar versión de mini app Claro Video";
    ...
    public static Performable validar() {
        return instrumented(ValidarVersionMiniProgramaClaroVideo.class);
    }
}
