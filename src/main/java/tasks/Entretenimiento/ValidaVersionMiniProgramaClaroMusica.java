...
public class ValidaVersionMiniProgramaClaroMusica implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    actor.attemptsTo(ClickTextoQueContengaX.elTextoContiene("Acerca de"), WaitFor.aTime(5000));
    EvidenciaUtils.registrarCaptura(paso2);
    // **********************************************************************************
    actor.attemptsTo(ValidarTextoQueContengaX.elTextoContiene("Ver"));
  ...
  public static Performable validar() {
    return instrumented(ValidaVersionMiniProgramaClaroMusica.class);
  }
}
