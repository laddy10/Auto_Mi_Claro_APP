...
public class CertificacionCuentaAlDia implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ScrollHastaTexto.conTexto(CERTIFICACION_CUENTA_AL_DIA)
        );
        ...
        actor.attemptsTo(
                ClickTextoQueContengaX.elTextoContiene(LINEAS_POSTPAGO)
        );
        ...
        try {
            ...
            theActorInTheSpotlight().should(seeThat(
                    ValidarElemento.esVisible(IMAG_CONSTANCIA_AL_DIA)));
