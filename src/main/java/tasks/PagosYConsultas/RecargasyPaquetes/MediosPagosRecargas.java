...
public class MediosPagosRecargas implements Task {
    ...
    private static final String pasoTarjeta = "a. Tarjeta crédito/débito: Redirección a formulario de tarjeta";
    private static final String pasoPse = "b. PSE - NEQUI: Redirección a portal PSE - NEQUI";
    private static final String pasoBancolombia = "c. Bancolombia: Redirección a portal de Bancolombia";
    private static final String pasoCodensa = "d. Codensa: Redirección a formulario Codensa";
    private static final String pasoOtrosMedios = "e. Otros medios de pago: Redirección a portal Otros medios de pago";
