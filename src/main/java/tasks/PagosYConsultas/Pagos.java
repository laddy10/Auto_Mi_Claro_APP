...
public class Pagos implements Task {
    ...
    private static final String paso4 = "Validar Línea postpago y direccionamiento portal pagos Claro";
    ...
    private static final String paso7 = "Validar Deudas en mora y direccionamiento portal pagos Claro";
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ClickElementByText.clickElementByText(PAGOS),
