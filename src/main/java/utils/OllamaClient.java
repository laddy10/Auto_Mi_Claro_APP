 ...
 *
 * <p>VERSIÓN OPTIMIZADA: ✅ Timeout aumentado a 3 minutos ✅ Manejo robusto de errores ✅ Logs
 * informativos
 */
public class OllamaClient {

  private static final String OLLAMA_URL =
      System.getProperty("ollama.url", "http://127.0.0.1:11434/api/generate");

  private static final String MODEL = System.getProperty("ollama.model", "Phi3");
  ...
  public String ask(String prompt) throws IOException {
    ...
    try {
      ...
      System.out.println(
          "[OLLAMA-CLIENT] ✅ Respuesta recibida en " + (duration / 1000) + " segundos");
      ...
      throw new IOException(
          "Ollama timeout - considera usar un modelo más rápido o aumentar el timeout", e);
    } catch (Exception e) {
      long duration = System.currentTimeMillis() - startTime;
      System.err.println(
          "[OLLAMA-CLIENT] ❌ Error después de "
              + (duration / 1000)
              + " segundos: "
              + e.getMessage());
