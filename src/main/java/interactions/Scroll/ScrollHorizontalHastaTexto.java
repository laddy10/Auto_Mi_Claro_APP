...
/**
 * Interaction que implementa scroll horizontal hasta encontrar un texto específico
 * Sigue el patrón Screenplay y mantiene consistencia con ScrollHastaTexto
 *
 * Principios SOLID aplicados:
 * - SRP: Única responsabilidad de hacer scroll horizontal hasta encontrar texto
 * - OCP: Abierta para extensión (se pueden agregar más parámetros)
 * - DIP: Depende de la abstracción Actor, no de implementaciones concretas
 *
...
public class ScrollHorizontalHastaTexto implements Interaction {
     ...
     */
    public static ScrollHorizontalHastaTexto conTextoAvanzado(String texto, int intentosMaximos, double velocidadScroll) {
        return Tasks.instrumented(ScrollHorizontalHastaTexto.class, texto, intentosMaximos, velocidadScroll);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        try {
            ...
            System.out.println("📋 Configuración - Intentos máximos: " + intentosMaximos + ", Velocidad: " + velocidadScroll);
            ...
            System.err.println("❌ Error durante scroll horizontal para texto '" + texto + "': " + e.getMessage());
            throw new RuntimeException("Fallo en scroll horizontal: " + e.getMessage(), e);
        }
    }

    /**
     * Implementación personalizada del scroll horizontal con los parámetros configurados
     * Mantiene la misma lógica robusta que el scroll vertical pero adaptada para horizontal
     *
    ...
    /**
     * Método privado que implementa el scroll horizontal con parámetros personalizados
     * Reutiliza la lógica de AndroidObject pero con configuración específica
     */
    private <T extends Actor> void scrollHorizontalConParametros(T actor, String texto, int intentos, double velocidad) {
