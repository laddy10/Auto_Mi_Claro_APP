...
/**
 * Interaction para realizar scroll horizontal simple
 * Complementa a ScrollHorizontalHastaTexto para casos donde solo se necesita scroll sin búsqueda
 *
 * Sigue el mismo patrón que la clase Scroll existente en el proyecto
 *
...
public class ScrollHorizontal extends AndroidObject implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        try {
            System.out.println("🔄 Ejecutando scroll horizontal hacia: " + direccion + " con velocidad: " + velocidad);
     ...
     */
    public static Interaction scrollHorizontalPersonalizado(DireccionHorizontal direccion, double velocidad) {
        // Validar velocidad
    ...
    /**
     * Método de conveniencia para mantener compatibilidad con el patrón existente
     * Equivalente a scrollHorizontalDerecha()
     *
