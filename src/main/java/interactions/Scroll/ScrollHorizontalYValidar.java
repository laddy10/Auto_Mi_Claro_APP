 ...
 * - Navegación por carruseles donde conoces la dirección pero necesitas validar el resultado
 * - Interfaces donde el scroll es determinístico pero quieres confirmar el elemento final
 * - Separación clara entre navegación y validación para mejor debugging
 *
 * Principios SOLID aplicados:
 * - SRP: Responsabilidad específica de scroll + validación secuencial
 * - OCP: Extensible para diferentes tipos de validación post-scroll
 * - DIP: Depende de abstracciones (AndroidObject, Validaciones)
 *
...
public class ScrollHorizontalYValidar implements Interaction {
     ...
     */
    public ScrollHorizontalYValidar(String textoAValidar, DireccionScroll direccion,
                                    int numeroScrolls, double velocidad, int tiempoEsperaValidacion) {
        this.textoAValidar = textoAValidar;
        this.direccion = direccion;
    ...
    private <T extends Actor> void validarTextoFinal(T actor) {
        ...
        actor.attemptsTo(
                ValidarTextoQueContengaX.elTextoContiene(textoAValidar)
        );
    ...
    public static ScrollHorizontalYValidar scrollAmbasDireccionesYValidar(String texto) {
        return Tasks.instrumented(ScrollHorizontalYValidar.class, texto, DireccionScroll.AMBAS_DIRECCIONES);
    }
     ...
     * @return Interaction configurada
     */
    public static ScrollHorizontalYValidar scrollPersonalizadoYValidar(String texto, DireccionScroll direccion,
                                                                       int numeroScrolls, double velocidad, int tiempoEspera) {
        return Tasks.instrumented(ScrollHorizontalYValidar.class, texto, direccion, numeroScrolls, velocidad, tiempoEspera);
    }
     ...
     */
    public static ScrollHorizontalYValidar scrollRapidoYValidar(String texto, DireccionScroll direccion) {
     ...
     */
    public static ScrollHorizontalYValidar scrollLentoYValidar(String texto, DireccionScroll direccion) {
        return Tasks.instrumented(ScrollHorizontalYValidar.class, texto, direccion, 2, 0.3, 2000);
    }

    // Getters para testing y debugging
    public String getTextoAValidar() { return textoAValidar; }
    public DireccionScroll getDireccion() { return direccion; }
    public int getNumeroScrolls() { return numeroScrolls; }
    public double getVelocidad() { return velocidad; }
    public int getTiempoEsperaValidacion() { return tiempoEsperaValidacion; }
}