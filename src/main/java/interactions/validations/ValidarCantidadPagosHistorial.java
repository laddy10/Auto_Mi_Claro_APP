...
public class ValidarCantidadPagosHistorial implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        List<WebElement> registrosPagos = AndroidObject.androidDriver(actor)
        ...
        if (cantidadPagos < cantidadMinima) {
            throw new AssertionError("Se esperaban al menos " + cantidadMinima +
                    " registros de pago, pero se encontraron " + cantidadPagos);
        }

        System.out.println("✅ Validación exitosa: Se encontraron " + cantidadPagos + " registros de pago");
    }
}