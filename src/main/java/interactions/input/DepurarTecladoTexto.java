...
public class DepurarTecladoTexto implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        try {
            ...
            List<WebElement> teclas = AndroidObject.androidDriver(actor)
                    .findElements(By.xpath("//android.view.View[@resource-id='__react-content']/android.view.View[2]/android.view.View//android.widget.TextView"));
            ...
            try {
                WebElement letraB = AndroidObject.androidDriver(actor)
