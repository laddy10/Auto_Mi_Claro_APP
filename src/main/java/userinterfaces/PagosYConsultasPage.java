...
public class PagosYConsultasPage {
  ...
  public static final Target CBX_TIPO_PAQUETE =
      Target.the("Combo seleccion tipo de paquetes")
          .located(AppiumBy.xpath("//*[@text='Paquetes de datos']"));
  public static final Target ICON_HOME =
      Target.the("Icono Home").located(AppiumBy.id("h5_tv_nav_back_to_home"));
  ...
  public static final Target TXT_CONTRASENA_FACTURA =
      Target.the("Campo contraseña factura").located(AppiumBy.id("com.android.chrome:id/password"));

  public static final Target URL_FACTURA_DESCARGADA =
      Target.the("URL factura descargada").located(AppiumBy.id("com.android.chrome:id/url_bar"));
  ...
  public static final Target LBL_APP_GRATIS =
      Target.the("Texto Aplicaciones gratis ya instaladas")
          .located(
              AppiumBy.xpath(
                  "//android.widget.TextView[@text=\"Aplicaciones gratis ya instaladas\"]"));
  ...
  public static final Target ICON_MAS_FAMILIA_Y_AMIGOS =
      Target.the("Icono de + familia y amigos").located(AppiumBy.xpath("//android.widget.Image"));
  ...
  public static final Target BTN_PAGAR =
      Target.the("Boton Pagar")
          .located(AppiumBy.xpath("//*[@text='Pagar' and @class='android.widget.Button']"));
