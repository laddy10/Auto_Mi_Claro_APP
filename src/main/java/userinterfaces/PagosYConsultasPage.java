...
public class PagosYConsultasPage {
  ...
  public static final Target BTN_PSE =
      Target.the("Boton PSE")
          .located(
              By.xpath(
                  "//android.view.View[@resource-id=\"__react-content\"]/android.view.View/android.widget.TextView[6]"));
  ...
  public static final Target CBX_TIPO_PAQUETE_RECARGAS =
      Target.the("Combo seleccion tipo de paquetes")
          .located(By.xpath("//android.widget.Button[@text=\"Paquetes todo incluido con redes\"]"));
  ...
  public static final Target ICON_DEBITO_PSE =
      Target.the("Icono Debito bancario PSE")
          .located(
              By.xpath(
                  "(((//*[@text='Portal Pagos Claro' and @class='android.webkit.WebView']/*[@class='android.view.View'])[2]/*/*[@class='android.view.View' and ./parent::*[@class='android.view.View']])[2]/*[@class='android.view.View'])[1]"));
  ...
  public static final Target ICON_DESCARGAR_FACTURA =
      Target.the("Boton descargar factura")
          .located(
              By.xpath(
                  "//android.view.View[@resource-id=\"__react-content\"]/android.view.View/android.widget.Button[1]"));

  public static final Target TXT_CONTRASENA_FACTURA =
      Target.the("Campo contraseña factura").located(By.id("com.android.chrome:id/password"));
  ...
  public static final Target POPUP_EQUIPO_REGISTRADO =
      Target.the("Texto fecha expiración")
          .located(
              By.xpath(
                  "//android.widget.TextView[@text=\"El equipo ya se encuentra registrado.\"]"));
  public static final Target ICON_MAS_FAMILIA_Y_AMIGOS =
      Target.the("Icono de + familia y amigos").located(By.xpath("//android.widget.Image"));
  public static final Target TXT_NUMERO_FAMILIA =
      Target.the("Caja de texto agregar numero familia y amigos")
          .located(
              By.xpath(
                  "//android.widget.TextView[@text=\"Agrega una nueva línea a Familia y Amigos\"]"));
  public static final Target ICON_ELIMINAR =
      Target.the("Icono ce eliminar")
          .located(
              By.xpath(
                  "//android.view.View[@resource-id=\"__react-content\"]/android.view.View/android.widget.Image[2]"));
  public static final Target IMAG_CONSTANCIA_AL_DIA =
      Target.the("Constancia de cuenta al dia").located(By.id("com.clarocolombia.miclaro:id/page"));
  ...
  public static final Target LBL_PAQUETE_ACTIVO =
      Target.the("Label paquete activo")
          .located(By.xpath("//android.widget.TextView[@text='PAQUETE ACTIVO']"));

  public static final Target BTN_VER_DETALLE_PAQUETE_ACTIVO =
      Target.the("Botón ver detalle paquete activo")
          .located(
              By.xpath(
                  "//android.widget.TextView[@text='PAQUETE ACTIVO']/following::android.widget.TextView[@text='Ver detalle del paquete'][1]"));

  public static final Target BTN_VER_DETALLE_PAQUETES =
      Target.the("Botones ver detalle de paquetes")
  ...
  public static final Target BTN_BACK_TO_HOME =
      Target.the("Botón regresar a inicio")
          .locatedBy(
              "//android.widget.TextView[@resource-id='com.clarocolombia.miclaro:id/h5_tv_nav_back_to_home']");

  public static final Target BTN_VER_DETALLE_PRIMER_PAQUETE =
      Target.the("Primer botón ver detalle")
          .located(By.xpath("(//android.widget.Button[@text='Ver detalle del paquete'])[1]"));

  public static final Target BTN_VER_DETALLE_SEGUNDO_PAQUETE =
  ...
  public static final Target TXT_CLARO =
      Target.the("Mensaje CLARO").located(By.xpath("//*[@text='CLARO']"));
