...
public class LoginPage {
    ...
    public static final Target LBL_ENCABEZADO_USUARIO =
            Target.the("Label Encabezado de usuario")
                    .located(AppiumBy.id("home_user_name_tv"));
    ...
    public static final Target LBL_INICIAR_SESION =
            Target.the("Texto Iniciar sesión")
                    .located(AppiumBy.xpath("//*[@text='Iniciar sesión']"));
    ...
    public static final Target BTN_ACEPTAR =
            Target.the("Boton Aceptar")
                    .located(AppiumBy.xpath("//*[@text='Aceptar']"));
    public static final Target BTN_PERMISO_UBICACION =
            Target.the("Botón mientras la app está en uso")
                    .located(AppiumBy.xpath(
                            "//*[translate(@text, 'ABCDEFGHIJKLMNOPQRSTUVWXYZÁÉÍÓÚ', 'abcdefghijklmnopqrstuvwxyzáéíóú') = '" + MIENTRAS_APP_ESTA_EN_USO + "']"
                    ));
    ...
    public static final Target SMS_PERMISO_LLAMADAS =
            Target.the("Mensaje ¿Permitir que Mi Claro haga y administre las llamadas telefónicas?")
                    .located(AppiumBy.xpath("//*[@text='¿Permitir que Mi Claro haga y administre las llamadas telefónicas?']"));
    ...
    public static final Target TXT_PASSWORD =
            Target.the("Ingresar Password")
                    .located(AppiumBy.id("input"));
    ...
    public static final Target BTN_CONTINUAR =
            Target.the("Botón continuar con cuenta activa")
                    .located(AppiumBy.id("login_entry_next"));
