...
public class LoginPage {
  ...
  public static final Target LBL_INGRESO_BIOMETRICO2 =
      Target.the("Boton Activar ingreso biometrico")
          .located(
              By.xpath(
                  "/hierarchy/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.FrameLayout/android.widget.RelativeLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.TextView[1]"));
  ...
  public static final Target LBL_PERMISO_ACCESO_UBICACION =
      Target.the("Texto permispo de acceso a tu ubicación")
          .located(
              By.xpath(
                  "/hierarchy/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.FrameLayout/android.widget.RelativeLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.RelativeLayout/android.view.ViewGroup/android.widget.TextView[1]"));

  public static final Target LBL_COMERCIO =
      Target.the("Textbox correo electrónico PSE")
          .located(
              MobileBy.AndroidUIAutomator("new UiSelector().resourceId(\"¿Qué quieres hoy?\")"));
}
