...
public class GestionaEquipoPage {
  ...
  public static final Target TAB_POSTPAGO =
      Target.the("Tab Postpago").located(AppiumBy.xpath("//*[@text='Postpago']"));

  public static final Target BTN_VER_DETALLE =
      Target.the("Botón Ver detalle").located(AppiumBy.xpath("//*[@text='Ver detalle']"));
  ...
  public static final Target BTN_REGISTRAR_EQUIPO =
      Target.the("Botón Registrar equipo").located(AppiumBy.xpath("//*[@text='Registrar equipo']"));
  ...
  public static final Target BTN_CONSULTAR_EQUIPO =
      Target.the("Botón Consultar equipo").located(AppiumBy.xpath("//*[@text='Consultar equipo']"));
  ...
  public static final Target BTN_REGISTRAR_MODAL =
      Target.the("Botón Registrar en modal").located(AppiumBy.xpath("//*[@text='Registrar']"));

  public static final Target BTN_CANCELAR_MODAL =
      Target.the("Botón Cancelar en modal").located(AppiumBy.xpath("//*[@text='Cancelar']"));
  ...
  public static final Target LBL_NUMERO_VALOR =
      Target.the("Valor del número de línea").located(AppiumBy.xpath("//*[@text='3108598508']"));

  public static final Target LBL_IMEI_VALOR =
      Target.the("Valor del IMEI").located(AppiumBy.xpath("//*[@text='860479068145924']"));

  public static final Target LBL_MARCA_VALOR =
      Target.the("Valor de la marca").located(AppiumBy.xpath("//*[@text='POCO']"));

  public static final Target LBL_MODELO_VALOR =
      Target.the("Valor del modelo").located(AppiumBy.xpath("//*[@text='2201116PG']"));

  public static final Target BTN_REPORTAR =
      Target.the("Botón Reportar").located(AppiumBy.xpath("//*[@text='Reportar']"));
  ...
  public static final Target BTN_CERRAR_MODAL =
      Target.the("Botón Cerrar modal").located(AppiumBy.xpath("//*[@text='Cerrar']"));
  ...
  public static final Target LBL_IMEI_CONSULTA =
      Target.the("IMEI en consulta").located(AppiumBy.xpath("//*[@text='860479068145924']"));

  public static final Target LBL_MARCA_CONSULTA =
      Target.the("Marca en consulta").located(AppiumBy.xpath("//*[@text='POCO']"));

  public static final Target LBL_MODELO_CONSULTA =
      Target.the("Modelo en consulta").located(AppiumBy.xpath("//*[@text='2201116PG']"));

  public static final Target LBL_ESTADO_EQUIPO =
      Target.the("Estado del equipo")
          .located(
              AppiumBy.xpath("//*[contains(@text,'Este celular ya fue registrado exitosamente')]"));
  ...
  public static final Target CARD_EQUIPO_POCO =
      Target.the("Card equipo POCO").located(AppiumBy.xpath("//*[@text='POCO']"));

  public static final Target CARD_EQUIPO_ALCATEL =
      Target.the("Card equipo Alcatel").located(AppiumBy.xpath("//*[@text='Alcatel']"));

  public static final Target CARD_EQUIPO_SAMSUNG =
      Target.the("Card equipo SAMSUNG").located(AppiumBy.xpath("//*[@text='SAMSUNG']"));
