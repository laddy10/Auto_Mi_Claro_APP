...
public class GestionaEquipoPage {
  ...
  public static final Target LBL_GESTIONA_TU_EQUIPO =
      Target.the("Etiqueta Gestiona tu equipo")
          .located(By.xpath("//*[@text='Gestiona tu equipo']"));
  ...
  public static final Target TAB_POSTPAGO =
      Target.the("Tab Postpago").located(By.xpath("//*[@text='Postpago']"));

  public static final Target BTN_VER_DETALLE =
      Target.the("Botón Ver detalle").located(By.xpath("//*[@text='Ver detalle']"));
  ...
  public static final Target LBL_CONFIRMA_NUMERO_DATOS =
      Target.the("Texto Confirma el número de línea y datos")
          .located(By.xpath("//*[contains(@text,'Confirma el número de línea y datos')]"));

  public static final Target LBL_NUMERO_VALOR =
      Target.the("Valor del número de línea").located(By.xpath("//*[@text='3108598508']"));

  public static final Target LBL_IMEI_VALOR =
      Target.the("Valor del IMEI").located(By.xpath("//*[@text='860479068145924']"));

  public static final Target LBL_MARCA_VALOR =
      Target.the("Valor de la marca").located(By.xpath("//*[@text='POCO']"));

  public static final Target LBL_MODELO_VALOR =
      Target.the("Valor del modelo").located(By.xpath("//*[@text='2201116PG']"));

  public static final Target BTN_REPORTAR =
      Target.the("Botón Reportar").located(By.xpath("//*[@text='Reportar']"));
  ...
  public static final Target BTN_REGISTRAR_LINEA_IMEI =
      Target.the("Botón Registrar la línea de tu IMEI")
          .located(By.xpath("//*[@text='Registrar la línea de tu IMEI']"));

  public static final Target BTN_GESTIONAR_LINEAS_IMEI =
      Target.the("Botón Gestionar las líneas de tu IMEI")
          .located(By.xpath("//*[@text='Gestionar las líneas de tu IMEI']"));
  ...
  public static final Target MODAL_RECONECTAR_INFO =
      Target.the("Modal información reconectar")
          .located(
              By.xpath(
                  "//*[contains(@text,'La línea') and contains(@text,'no están reportados')]"));

  public static final Target BTN_CERRAR_MODAL =
      Target.the("Botón Cerrar modal").located(By.xpath("//*[@text='Cerrar']"));

  // Consultar equipo
  public static final Target LBL_CONSULTAR_TITULO =
      Target.the("Título Consultar equipo").located(By.xpath("//*[@text='Consultar equipo']"));

  public static final Target LBL_TU_EQUIPO_ACTUAL =
      Target.the("Sección Tu equipo actual").located(By.xpath("//*[@text='Tu equipo actual']"));

  public static final Target LBL_IMEI_CONSULTA =
      Target.the("IMEI en consulta").located(By.xpath("//*[@text='860479068145924']"));

  public static final Target LBL_MARCA_CONSULTA =
      Target.the("Marca en consulta").located(By.xpath("//*[@text='POCO']"));

  public static final Target LBL_MODELO_CONSULTA =
      Target.the("Modelo en consulta").located(By.xpath("//*[@text='2201116PG']"));

  public static final Target LBL_ESTADO_EQUIPO =
      Target.the("Estado del equipo")
          .located(By.xpath("//*[contains(@text,'Este celular ya fue registrado exitosamente')]"));
  ...
  public static final Target CARD_EQUIPO_POCO =
      Target.the("Card equipo POCO").located(By.xpath("//*[@text='POCO']"));

  public static final Target CARD_EQUIPO_ALCATEL =
      Target.the("Card equipo Alcatel").located(By.xpath("//*[@text='Alcatel']"));

  public static final Target CARD_EQUIPO_SAMSUNG =
      Target.the("Card equipo SAMSUNG").located(By.xpath("//*[@text='SAMSUNG']"));

  // Elementos de navegación hacia la derecha en las cards
  public static final Target ARROW_POCO =
      Target.the("Flecha tarjeta POCO").located(By.xpath("//*[@text='POCO']/following-sibling::*"));

  public static final Target ARROW_ALCATEL =
      Target.the("Flecha tarjeta Alcatel")
          .located(By.xpath("//*[@text='Alcatel']/following-sibling::*"));

  public static final Target ARROW_SAMSUNG =
      Target.the("Flecha tarjeta SAMSUNG")
          .located(By.xpath("//*[@text='SAMSUNG']/following-sibling::*"));
}
