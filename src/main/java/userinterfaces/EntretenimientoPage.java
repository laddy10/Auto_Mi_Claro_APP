...
public class EntretenimientoPage {
  ...
  public static final Target BTN_CONTINUAR =
      Target.the("Botón Continuar Netflix").located(By.xpath("//*[@text='Continuar']"));

  public static final Target BTN_CLOSE =
      Target.the("Botón Close")
  ...
  public static final Target RADIO_BT_ACEPTAR =
      Target.the("Botón 'Aceptar'")
          .locatedBy("//*[@class='android.view.View' and ./*[@text='Aceptar']]");

  public static final Target IMAGEN_NETFLIX =
      Target.the("Imagen genérica en la App Mi Claro").located(By.xpath("//android.widget.Image"));
  ...
  public static final Target LBL_HECHO_PARA_TI =
      Target.the("Título Hecho para ti").located(By.xpath("//*[@text='Hecho para ti']"));
  ...
  public static final Target BTN_CLARO_TV_PLUS =
      Target.the("Botón Claro tv +").located(By.xpath("//*[@text='Claro tv +']"));

  public static final Target BTN_RED_TV_EN_VIVO =
      Target.the("Botón Red + TV en vivo").located(By.xpath("//*[@text='Red + TV en vivo']"));

  public static final Target BTN_CLARO_VIDEO =
      Target.the("Botón Claro Video").located(By.xpath("//*[@text='Claro Video']"));

  public static final Target BTN_CLARO_MUSICA =
      Target.the("Botón Claro Música").located(By.xpath("//*[@text='Claro Música']"));
  ...
  public static final Target BTN_NETFLIX =
      Target.the("Botón Netflix").located(By.xpath("//*[@text='Netflix']"));

  public static final Target BTN_HBOMAX =
      Target.the("Botón HBOmax").located(By.xpath("//*[@text='HBOmax']"));

  public static final Target BTN_AMAZON_PRIME =
      Target.the("Botón Amazon Prime").located(By.xpath("//*[@text='Amazon Prime']"));

  public static final Target BTN_VER_MAS_PLATAFORMAS =
      Target.the("Botón Ver más en plataformas").located(By.xpath("//*[@text='Ver más']"));
  ...
  public static final Target BTN_OPEN =
      Target.the("Botón OPEN para abrir aplicación externa").located(By.xpath("//*[@text='OPEN']"));
  ...
  public static final Target LBL_CLARO_MUSICA_TITULO =
      Target.the("Título Claro Música").located(By.xpath("//*[@text='Claro Música']"));
  ...
  public static final Target TAB_POSTPAGO_MUSICA =
      Target.the("Tab Postpago en Claro Música").located(By.xpath("//*[@text='Postpago']"));

  // Líneas específicas para Claro Música
  public static final Target LINEA_310_262_8443 =
      Target.the("Línea 310 262 8443").located(By.xpath("//*[@text='Línea 310 262 8443']"));

  public static final Target LINEA_310_263_5941 =
      Target.the("Línea 310 263 5941").located(By.xpath("//*[@text='Línea 310 263 5941']"));

  public static final Target LINEA_322_278_6448 =
      Target.the("Línea 322 278 6448").located(By.xpath("//*[@text='Línea 322 278 6448']"));
  ...
  public static final Target LBL_NETFLIX_TITULO =
      Target.the("Título Netflix").located(By.xpath("//*[@text='Netflix']"));

  public static final Target LBL_ELIGE_NUMERO_CUENTA_NETFLIX =
      Target.the("Texto Elige el número de cuenta o línea")
          .located(By.xpath("//*[@text='Elige el número de cuenta o línea']"));
  public static final Target LBL_NETFLIX_LOGO =
      Target.the("Logo NETFLIX").located(By.xpath("//*[@text='NETFLIX']"));
  ...
  public static final Target LBL_CODIGO_VENDEDOR =
      Target.the("Label Código del vendedor").located(By.xpath("//*[@text='Código del vendedor']"));
  ...
  public static final Target LBL_AMAZON_PRIME_TITULO =
      Target.the("Título Amazon Prime").located(By.xpath("//*[@text='Amazon Prime']"));
  ...
  public static final Target LBL_AMAZON_PRIME_LOGO =
      Target.the("Logo amazon prime").located(By.xpath("//*[@text='amazon prime']"));
  ...
  public static final Target LBL_PRECIO_24900 =
      Target.the("Precio $ 24.900/mes").located(By.xpath("//*[@text='$ 24.900/mes']"));

  public static final Target LBL_IVA_INCLUIDO =
      Target.the("Texto IVA incluido").located(By.xpath("//*[@text='IVA incluido']"));
  ...
  public static final Target LBL_PRIME_GAMING =
      Target.the("Título Prime Gaming").located(By.xpath("//*[@text='Prime Gaming']"));
  ...
  public static final Target LBL_LINEA_POSTPAGO =
      Target.the("Label Línea postpago").located(By.xpath("//*[@text='Línea postpago']"));

  public static final Target LBL_NUMERO_LINEA_PRIME =
      Target.the("Número de línea Amazon Prime").located(By.xpath("//*[@text='310 262 8443']"));
  ...
  public static final Target BTN_ACEPTAR_AMAZON =
      Target.the("Botón Aceptar").located(By.xpath("//android.widget.Button[@text='Aceptar']"));

  public static final Target LBL_VALOR_FINAL =
      Target.the("Valor final").located(By.xpath("//*[@text='Valor']"));
  ...
  public static final Target BTN_WIN_PLAY =
      Target.the("Botón Win Play").located(By.xpath("//*[@text='Win Play']"));

  public static final Target BTN_DISNEY_PLUS =
      Target.the("Botón Disney+").located(By.xpath("//*[@text='Disney+']"));

  public static final Target BTN_HOTGO =
      Target.the("Botón HotGo").located(By.xpath("//*[@text='HotGo']"));

  public static final Target BTN_RED_NOTICIAS =
      Target.the("Botón RED + NOTICIAS").located(By.xpath("//*[@text='RED + NOTICIAS']"));

  // Disney+ específicos
  public static final Target BTN_PLAN_ESTANDAR =
      Target.the("Botón Plan Estándar Disney+").located(By.xpath("//*[@text='Plan Estándar']"));
  ...
  public static final Target BTN_ALERT_CONFIRM =
      Target.the("Botón confirmar alerta")
          .located(
              By.xpath(
                  "//android.widget.Button[@resource-id='com.claro.claromusica.latam:id/btn_alert_confirm']"));

  public static final Target LBL_MENSAJE_ALERT =
      Target.the("mensaje de alerta")
          .located(
              By.xpath(
                  "//android.widget.TextView[@resource-id='com.claro.claromusica.latam:id/tv_message']"));

  public static final Target MENU_CATEGORIAS =
      Target.the("Menú de categorías")
          .located(By.xpath("//android.view.View[@resource-id='categoriesmenu']"));

  public static final Target MAS_DESCARGADOS =
      Target.the("Botón 'Más Descargados'")
          .located(By.xpath("//android.view.View[contains(@content-desc, 'Más Descargados')]"));

  public static final Target COMIDAS =
      Target.the("Botón 'Comidas'")
          .located(By.xpath("//android.view.View[contains(@content-desc, 'Comidas')]"));

  public static final Target PRODUCTOS_CLARO =
      Target.the("Botón 'Productos Claro'")
          .located(By.xpath("//android.view.View[contains(@content-desc, 'Productos Claro')]"));

  public static final Target VIAJES =
      Target.the("Botón 'Viajes'")
          .located(By.xpath("//android.view.View[contains(@content-desc, 'Viajes')]"));

  public static final Target ENTRETENIMIENTO_CLAROCLUB =
      Target.the("Botón 'Entretenimiento'")
          .located(By.xpath("//android.view.View[contains(@content-desc, 'Entretenimiento')]"));

  public static final Target MASCOTAS =
      Target.the("Botón 'Mascotas'")
          .located(By.xpath("//android.view.View[contains(@content-desc, 'Mascotas')]"));

  public static final Target VARIEDADES =
      Target.the("Botón 'Variedades'")
          .located(By.xpath("//android.view.View[contains(@content-desc, 'Variedades')]"));

  public static final Target EDUCACION =
      Target.the("Botón 'Educación'")
  ...
  public static final Target BTN_ACEPTAR_CONTINUAR =
      Target.the("Botón Aceptar y continuar").locatedBy("//*[@text='Aceptar y continuar']");

  public static final Target MSJ_ALERTA_INGRESO =
      Target.the("Mensaje de alerta ¡Bienvenido! Disfruta gratis")
          .locatedBy(
              "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.widget.TextView[3]");

  public static final Target LOGO_CLARO_MUSICA =
      Target.the("Logo claro musica dentro de la app")
          .locatedBy("//android.widget.ImageView[@content-desc=\"Cm Logo\"]");

  public static final Target BTN_ENTENDIDO =
      Target.the("Botón entendido")
          .locatedBy(
