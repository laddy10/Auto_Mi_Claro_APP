...
public class ConsultarConsumosPage {
  ...
  public static final Target LBL_TU_PLAN =
      Target.the("Sección Tu plan").located(AppiumBy.xpath("//*[@text='Tu plan']"));
  ...
  public static final Target LBL_GB_PLAN_160 =
      Target.the("160,00 GB plan").located(AppiumBy.xpath("//*[@text='160,00 GB plan']"));

  public static final Target LBL_FECHA_INICIO =
      Target.the("Fecha inicio").located(AppiumBy.xpath("//*[contains(@text,'Fecha inicio:')]"));

  public static final Target LBL_FECHA_CARGA =
      Target.the("Fecha carga").located(AppiumBy.xpath("//*[contains(@text,'Fecha carga:')]"));
  ...
  public static final Target BTN_CONSUMO_DATOS =
      Target.the("Botón Consumo de datos").located(AppiumBy.xpath("//*[@text='Consumo de datos']"));
  ...
  public static final Target BTN_CONSUMO_VOZ =
      Target.the("Botón Consumo de voz").located(AppiumBy.xpath("//*[@text='Consumo de voz']"));

  public static final Target BTN_CONSUMO_SMS =
      Target.the("Botón Consumo de SMS").located(AppiumBy.xpath("//*[@text='Consumo de SMS']"));
  ...
  public static final Target LBL_TU_PLAN_DATOS =
      Target.the("Tu plan en datos").located(AppiumBy.xpath("//*[@text='Tu plan']"));

  public static final Target LBL_CONSUMIDO_DEL_PLAN =
      Target.the("Consumido del plan").located(AppiumBy.xpath("//*[@text='Consumido del plan']"));

  public static final Target LBL_CONSUMIDO_1_40_GB =
      Target.the("1,40 GB consumido").located(AppiumBy.xpath("//*[@text='1,40 GB']"));
  ...
  public static final Target LBL_PAQUETES_0_00_GB =
      Target.the("0,00 GB paquetes").located(AppiumBy.xpath("//*[@text='0,00 GB']"));
  ...
  public static final Target LBL_PASAPORTE_AMERICA =
      Target.the("Pasaporte América").located(AppiumBy.xpath("//*[@text='Pasaporte América']"));
  ...
  public static final Target LBL_FACEBOOK =
      Target.the("Facebook").located(AppiumBy.xpath("//*[@text='Facebook']"));

  public static final Target LBL_FACEBOOK_CONSUMIDO =
      Target.the("Has consumido Facebook 0,00 GB")
          .located(
              AppiumBy.xpath("//*[contains(@text,'Has consumido') and contains(@text,'0,00 GB')]"));
  ...
  public static final Target LBL_SALDO_DISPONIBLE =
      Target.the("Saldo disponible").located(AppiumBy.xpath("//*[@text='Saldo disponible']"));

  public static final Target LBL_SALDO_0_PESOS =
      Target.the("$ 0").located(AppiumBy.xpath("//*[@text='$ 0']"));
  ...
  public static final Target LBL_FECHA_2025_03_03 =
      Target.the("Fecha 2025/03/03").located(AppiumBy.xpath("//*[@text='2025/03/03']"));

  public static final Target LBL_CONSULTA_PAQUETES_ACTIVOS =
      Target.the("Consulta los paquetes y recargas activos")
          .located(
              AppiumBy.xpath("//*[contains(@text,'Consulta los paquetes y recargas activos')]"));

  // Tabs de paquetes y recargas
  public static final Target TAB_PAQUETES =
      Target.the("Tab Paquetes").located(AppiumBy.xpath("//*[@text='Paquetes']"));

  public static final Target TAB_RECARGAS =
      Target.the("Tab Recargas").located(AppiumBy.xpath("//*[@text='Recargas']"));

  public static final Target TAB_CONSUMO_DEL_MES =
      Target.the("Tab Consumo del mes").located(AppiumBy.xpath("//*[@text='Consumo del mes']"));

  // Información adicional
  public static final Target LBL_HAZ_RECARGA_RENOVAR =
      Target.the("Haz una recarga para renovar la vigencia")
          .located(
              AppiumBy.xpath("//*[contains(@text,'Haz una recarga para renovar la vigencia')]"));
  ...
  public static final Target LBL_JUNIO_2025 =
      Target.the("Junio 2025").located(AppiumBy.xpath("//*[@text='Junio 2025']"));

  public static final Target LBL_OTROS =
      Target.the("Otros").located(AppiumBy.xpath("//*[@text='Otros']"));

  public static final Target BTN_VER_DETALLE_SALDO =
      Target.the("Ver detalle del saldo").located(AppiumBy.xpath("//*[@text='Ver detalle']"));
