...
public class ConsultarConsumosPage {
  ...
  public static final Target BTN_CONSULTAR_CONSUMOS =
      Target.the("Botón Consultar consumos").located(By.xpath("//*[@text='Consultar consumos']"));
  ...
  public static final Target LBL_NUMERO_LINEA =
      Target.the("Número de línea 310 263 2840").located(By.xpath("//*[@text='310 263 2840']"));
  ...
  public static final Target LBL_CONSUMO_DATOS_TITULO =
      Target.the("Título Consumo de datos").located(By.xpath("//*[@text='Consumo de datos']"));
  ...
  public static final Target LBL_ROAMING_INTERNACIONAL =
      Target.the("Roaming Internacional").located(By.xpath("//*[@text='Roaming Internacional']"));
  ...
  public static final Target LBL_RESTO_MUNDO =
      Target.the("Resto del Mundo").located(By.xpath("//*[contains(@text,'Resto del Mundo')]"));
  ...
  public static final Target LBL_DATOS_CONSUMIDOS =
      Target.the("Datos Consumidos").located(By.xpath("//*[contains(@text,'Datos Consumidos')]"));
  ...
  public static final Target LBL_FACEBOOK_CONSUMIDO =
      Target.the("Has consumido Facebook 0,00 GB")
          .located(By.xpath("//*[contains(@text,'Has consumido') and contains(@text,'0,00 GB')]"));
  ...
  public static final Target LBL_FECHA_VENCIMIENTO =
      Target.the("Fecha de vencimiento").located(By.xpath("//*[@text='Fecha de vencimiento']"));
  ...
  public static final Target LBL_CONSULTA_PAQUETES_ACTIVOS =
      Target.the("Consulta los paquetes y recargas activos")
          .located(By.xpath("//*[contains(@text,'Consulta los paquetes y recargas activos')]"));
  ...
  public static final Target LBL_HAZ_RECARGA_RENOVAR =
      Target.the("Haz una recarga para renovar la vigencia")
          .located(By.xpath("//*[contains(@text,'Haz una recarga para renovar la vigencia')]"));

  public static final Target LBL_SALDO_MES_ANTERIOR =
      Target.the("Saldo del mes anterior").located(By.xpath("//*[@text='Saldo del mes anterior']"));
